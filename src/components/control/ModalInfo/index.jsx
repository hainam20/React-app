...
const ModalInfo = (props) => {
    ...
    const { handleModalInfo, tempState, waterState, soilState, handleModalChange, handleSaveCondition, index } = props;
        ...
        <div className="fixed w-screen h-screen top-0 left-0 bottom-0 right-0 bg-[rgb(89,89,89)] bg-opacity-90 flex justify-center items-center drop-shadow-2xl shadow-2xl z-[120]">
            <div ref={modalRef} className="bg-white w-2/3 h-fit rounded-lg p-6 flex flex-wrap justify-center relative">
                ...
                <div className="absolute bottom-0 right-0">
                    ...
                    <button onClick={() => handleSaveCondition(index)} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Save</button>
                </div>
